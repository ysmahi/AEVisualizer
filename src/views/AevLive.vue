<template>
    <div id="aevLive">
        <div id='existingGraphs'>
            <input type="file" style="display: none" ref="fileInputRoadmap"
                   v-on:change="getDataFromFileAndDisplayChart"/>
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"
                    v-on:click="triggerLoadFileRoadmap">
                Roadmap
            </button>
...
<script>
  ...
  export default {
    ...
    methods: {
      triggerLoadFileRoadmap () {
        // Simulate a click on the input button
        this.$refs.fileInputRoadmap.click()
      },
      displayChart: function () {
        let mappedData = mapData(this.dataFile)
        this.mappedData = mappedData
        drawChart('#chart', mappedData)
      },
      ...
      getDataFromFileAndDisplayChart () {
        // Open file, read it, and display chart
        if (!this.onReload) this.selectedFile = this.$refs.fileInputRoadmap.files[0]
